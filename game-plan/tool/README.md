...
Výběr Kostry se vždy potvrzuje a založí novou osmifázovou rozpracovanou animaci se stejnou kostrou ve všech snímcích; animace vybraná u postavy se odpojí. Hotová animace ukládá také použitou Bitmapovou předlohu a Kostru. Při jejím načtení se oba výběry obnoví a aktivní animace postavy se rovněž odpojí. Starší záznamy bez těchto odkazů používají aktuální bitmapovou předlohu a kostru se pokusí určit podle prvního snímku.
